<%@page import="io.zilker.zbuy.bean.Items"%>
<%@page import="io.zilker.zbuy.delegate.GroceryDBUtil"%>
<%@page import="io.zilker.zbuy.bean.Grocery"%>
...
// Fetch item details from the item id

GroceryDBUtil groceryDBUtil = new GroceryDBUtil();
Items item = groceryDBUtil.fetchItemDetails(itemId);
            ...
            <div class="row">
                ...
                <div class="col-xs-12  col-sm-12  col-md-12 col-lg-12  box  ">
                    ...
                    <div class="box-body ">
                        <div class="display-center">
                            <table class="text-right">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <label for="product-id" class="bold">Product ID: </label>
                                        </td>
                                        <td>
                                            <input type="text" class="text-box" name="product-id" id="product-id" value="${item.itemId }" disabled>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" class="text-box" name="product-name" id="product-name" value="${item.itemName }">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" class="text-box" name="price" id="price" value="${item.itemPrice }">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" class="text-box" name="quantity" id="quantity" value="${item.quantity }">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" class="text-box" name="unit  " id="unit" value="${item.units }">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                        ...
                        <div class="display-center">
                            <input type="submit" class="btn button success" value="Save" name="Edit" id="edit">
                        </div>
